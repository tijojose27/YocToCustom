...
//--- (end of generated code: YModule class start)
     ...
     * @throws YAPI_Exception on error
     */
    public int registerLogCallback(LogCallback callback) throws YAPI_Exception
    {
        String serial;
     ...
     */
    public int registerConfigChangeCallback(ConfigChangeCallback callback)
    {
        if (callback != null) {
     ...
     */
    public int registerBeaconCallback(BeaconCallback callback)
    {
        if (callback != null) {
            YModule._updateModuleCallbackList(this, true);
        } else {
